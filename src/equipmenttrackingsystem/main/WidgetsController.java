 ...
 * @author CE
 */
public class WidgetsController implements Initializable {
    ...
    private void refreshNodes() throws DataStorageException, NotFoundException {
        ...
        ArrayList<MaterialRequisition> daBook2 = MaterialRequisition.getAllRequisition3();
        ...
        for (int i = 0; i < daBook2.size(); i++) {
            try {
                ...
                loader.setLocation(MainFormController.class.getResource("Item2.fxml"));
                Pane pane = loader.load();

                ItemController2 c = (ItemController2) loader.getController();
    ...
    @FXML
    private void onTotal(MouseEvent event) throws JRException, DataStorageException {
