...
public class ItemController2 {
    ...
    public void setBooking(MaterialRequisition log, long selectedRequisitionId) {
        ...
        try {
            ...
            Logger.getLogger(ItemController2.class.getName()).log(Level.SEVERE, null, ex);
...
//            System.out.println(ppeName);
        ...
        lblAssignedEmployee.setText(MaterialRequisitionDA.getEmployeeName(aloc.getEmployeeID()));
